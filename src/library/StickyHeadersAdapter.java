...
public interface StickyHeadersAdapter<HeaderViewHolder extends RecyclerView.ViewHolder> {
	...
	/**
	 * Create a header {@link android.support.v7.widget.RecyclerView.ViewHolder
	 * ViewHolder} witch encapsulate the header view You can either create a
	 * View manually or inflate it from an XML layout file.
	 * 
	 * @param parent
	 *            the parent {@link android.view.ViewGroup ViewGroup}
	 ...
	 *            the ViewHolder containing the view to bind
	 * @param position
